...
A Java application to manage books and authors using layered architecture (Bean, DAO, Service).
It supports adding, viewing, and managing book records with database connectivity.
